...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def mix(
        ...
        prev_output_tokens_b: Optional[Tensor] = None,
        ...
        if prev_output_tokens_b is not None:
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def extract_features_mix(
        ...
        # Based on prev output tokens a
        if self.cross_self_attention or prev_output_tokens_a.eq(self.padding_idx).any():
            self_attn_padding_mask = prev_output_tokens_a.eq(self.padding_idx)
